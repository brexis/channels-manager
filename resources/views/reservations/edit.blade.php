                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('listings.reservations.update', [$listing->id, $reservation->id]) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" required autocomplete="description">{{ $reservation->description }}</textarea>
